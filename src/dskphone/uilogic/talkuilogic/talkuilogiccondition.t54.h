...
//会议人员数量
#define MAX_CONF_PARTY_NUM 2

//是否显示dsskey
#define IF_TALKUI_DSSKEY 1

//是否有显示头像功能
#define IF_TALKUI_CONTACT_PHOTO 1

#if IF_TALKUI_CONTACT_PHOTO
//头像是否有动画（头像动画显示时，另一个动画不显示）
#define IF_TALKUI_CONTACT_PHOTO_ANIMATION    1

#define TALK_CONTACT_IMAGE_WIDTH        60
#define TALK_CONTACT_IMAGE_HEIGHT       60
#endif

//是否有绘制背景功能
#define IF_TALKUI_BG_PICTURE 1

//通话背景是否是与idle相同的风格
#define IF_TALKUI_BG_IDLE_STYLE 1

//拨号背景绘制方式
#define IF_TALKUI_BIG_DIAL_BG 0

//全屏类型界面是否需要单独绘制背景
#define IF_TALKUI_DIFF_BG 1

//是否存在多个账号
#define IF_TALKUI_MULTY_ACCOUNT 1

//只有一路通话时是否显示页码
#define IF_TALKUI_ONE_PAGE_SHOW_NOTE 0
...
#define IF_TALKUI_HANDFREE_DIAL 0

//挂机是否退出通话，常见于CP
#define IF_TALKUI_ONHOOK_EXITCALL 0

//挂机只退出conf manager而不挂断通话，常见于CP
#define IF_TALKUI_ONHOOK_EXIT_CONFMANAGER 0

//拨号界面收到账号改变的消息是否呼出，常见于CP
#define IF_TALKUI_DIAL_CHANGEACCOUNT_CALLOUT 0
...
#define IF_TALKUI_INCOMING_CALL_COMBINE  0
//hold、mute信息是否与talk公用控件位置冲突
#define IF_TALKUI_CONFLICT_STYLE        0
//trans fail信息是否合在一行中显示
#define IF_TALKUI_TRANS_FAIL_INFO_IN_ONE_LINE        1

//autoredial信息是否能完整显示下
#define IF_AUTO_REDIAL_SHOW_FULL     0

//通话界面显示行数变化时，字体大小是否需要发生变化
#define IF_TALKUI_FONT_SIZE_CHANGE      0

#if IF_TALKUI_FONT_SIZE_CHANGE
//是否在变化为两行时就改变字体大小，否则为三行
#define IF_TALKUI_FONT_SIZE_CHANGE_WHEN_TWO 1

#define RINGINGUI_FONT_SIZE_BIG         20
#define RINGINGUI_FONT_SIZE_SMALL   10

#define RINGINGUI_MARGIN_BOTTOM_BIG         6
#define RINGINGUI_MARGIN_BOTTOM_SMALL   2
#endif


//来电界面的目标信息中名字和号码是否分开显示
#define IF_TALKUI_RINGUI_TARGET_SPLIT      1
...
#define IF_CONF_MANAGER_ITEM_HD_SPECIAL       1

//title是否使用固定样式的图标列表
#define IF_TITLE_ICON_FIXED          0

//网络会议界面的显示方式：0、显示成员列表；1、仅显示member
#define IF_NETCONF_UI_STYLE     0

//transfer fail 时，提示信息是否无视头像显示状态进行显示
#define IF_TRANSFER_FAIL_HINT_STYLE     1

//会议中安全等级提示是否显示在title
#define IF_CONF_SECURITY_IN_TITLE           1
