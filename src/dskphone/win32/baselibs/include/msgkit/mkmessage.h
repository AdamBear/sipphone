...
#ifdef WIN32
#ifdef BASELIB_BUILD
#define MK_EXPORT_DECL_SPECIFIER    __declspec(dllexport)
#define MK_EXPORT_DEF_SPECIFIER     __declspec(dllexport)
#else
#define MK_EXPORT_DECL_SPECIFIER    __declspec(dllimport)
#define MK_EXPORT_DEF_SPECIFIER     __declspec(dllimport)
#endif

#define MK_DECL(type)       MK_EXPORT_DECL_SPECIFIER type
#define MK_DEF(type)        MK_EXPORT_DEF_SPECIFIER  type

#include <stddef.h>
#define inline  __inline

#else
#define MK_DECL(type)       type
#define MK_DEF(type)        type
#endif
...
#ifdef WIN32
#define MKIT_MSG_MAX_DEPTH   (96)          /*max depth */
#define MKIT_MSG_DEF_DEPTH   (16)           /*default depth */
#define MKIT_MSG_MAX_BUFF    (32*1024)     /*max buffer size of each user*/
...
*
*/
MK_DECL(int)  mkit_get_current(mkit_handle_t * handle);
...
*
*/
MK_DECL(void *) mkit_get_private(mkit_handle_t handle);
...
*
*/
MK_DECL(int) mkit_get_filedes(mkit_handle_t handle);
...
*
*/
MK_DECL(int)  mkit_get_target(mkit_handle_t handle, mkit_target_t * ptarget);
...
*
*/
MK_DECL(int)  mkit_get_buffer(mkit_handle_t handle, unsigned long * base, unsigned int * size);
...
*
*/
MK_DECL(int)  mkit_get_taskid(mkit_handle_t handle);
MK_DECL(int)  mkit_get_threadid(mkit_handle_t handle);
...
*
*/
MK_DECL(int)  mkit_get_active(mkit_handle_t handle, mkit_target_t target);
...
*
*/
MK_DECL(int)  mkit_set_active(mkit_handle_t handle, int active);
...
*
*/
MK_DECL(int)  mkit_create(mkit_handle_t * handle, const char * name, int flags);
MK_DECL(int)  mkit_create2(mkit_handle_t * handle, const char * name, int depth, int buf_max,
                           int buf_per, int tmr_max, void * private_data, int flags);
...
*
*/
MK_DECL(int)  mkit_destroy(mkit_handle_t  handle);
...
*
*/
MK_DECL(int)  mkit_exist(mkit_handle_t handle, const char * name);
MK_DECL(int)  mkit_name(mkit_handle_t handle, mkit_target_t  target, char * name);
MK_DECL(int)  mkit_topid(mkit_handle_t handle, unsigned int * pid,   const char * name);
MK_DECL(int)  mkit_find(mkit_handle_t handle, mkit_target_t * target, const char * name);
MK_DECL(int)  mkit_next(mkit_handle_t handle, mkit_target_t * target);
MK_DECL(int)  mkit_find2(mkit_handle_t handle, mkit_query_t * query);
MK_DECL(int)  mkit_next2(mkit_handle_t handle, mkit_query_t * query);
...
*
*/
MK_DECL(int)  mkit_peek(mkit_handle_t handle, mkit_message_t * msg);
...
*
*/
MK_DECL(int)  mkit_send2(mkit_handle_t handle, mkit_message_t * msg);
MK_DECL(int)  mkit_post2(mkit_handle_t handle, mkit_message_t * msg);
MK_DECL(int)  mkit_bcast(mkit_handle_t handle, mkit_message_t * msg);
...
*
*/
MK_DECL(int)  mkit_call(mkit_handle_t handle, mkit_message_t * msg);
...
*
*/
MK_DECL(int)  mkit_reply(mkit_handle_t handle, mkit_message_t * msg);

static inline int  mkit_return(mkit_handle_t handle, unsigned long wparam, unsigned long lparam,
...
*
*/
MK_DECL(int)  mkit_flush(mkit_handle_t handle, int * flushed);
...
*
*/
MK_DECL(int)  mkit_set_timer(mkit_handle_t handle, int id, int ms_interval);
MK_DECL(int)  mkit_set_timer2(mkit_handle_t handle, int id, int ms_interval, int message,
                              int flags);
MK_DECL(int)  mkit_kill_timer(mkit_handle_t handle, int id);
MK_DECL(int)  mkit_reset_timer(mkit_handle_t handle);
...
static inline int  mkit_send(mkit_handle_t handle, mkit_target_t target,
                             unsigned int msg, unsigned long wparam, unsigned long lparam, void * data, int data_siz,
                             int timeout)
{
...
*
*/
MK_DECL(int) mkit_notify_create(mkit_notify_t * phandle, mkit_handle_t owner, int notify_max);
MK_DECL(int) mkit_notify_destroy(mkit_notify_t  handle);
...
*
*/
MK_DECL(int) mkit_notify_add(mkit_notify_t  handle, mkit_target_t caller, int count);
MK_DECL(int) mkit_notify_del(mkit_notify_t  handle, mkit_target_t caller);
...
*
*/
MK_DECL(int) mkit_notify_post(mkit_notify_t  handle, int message, unsigned long  wparam,
                              unsigned long  lparam, const void * data, int data_len);
MK_DECL(int) mkit_notify_send(mkit_notify_t  handle, int message, unsigned long  wparam,
                              unsigned long  lparam, const void * data, int data_len);
MK_DECL(int) mkit_notify_call(mkit_notify_t  handle, int message, unsigned long  wparam,
                              unsigned long  lparam, int timeout);
...
*
*/
MK_DECL(int) mkit_notify_request(mkit_handle_t caller, mkit_target_t notifier, int event,
                                 int count);
MK_DECL(int) mkit_notify_cancel(mkit_handle_t caller, mkit_target_t notifier, int event);

/************************************************************************/
/* APIs for anonymous access                                            */
/************************************************************************/
MK_DECL(int)  mkit_anonymous_create(int * fd_handle);
MK_DECL(int)  mkit_anonymous_destroy(int fd_handle);
MK_DECL(int)  mkit_anonymous_send2(int fd_handle, mkit_message_t * msg);
MK_DECL(int)  mkit_anonymous_post2(int fd_handle, mkit_message_t * msg);
MK_DECL(int)  mkit_anonymous_bcast(int fd_handle, mkit_message_t * msg);
MK_DECL(int)  mkit_anonymous_call2(int fd_handle, mkit_message_t * msg);
MK_DECL(int)  mkit_anonymous_find(int fd_handle, mkit_query_t * query);
MK_DECL(int)  mkit_anonymous_next(int fd_handle, mkit_query_t * query);
