...
#define MKSRV_ID_H323         8
#define MKSRV_ID_BTD          10    /*bluetoothd service*/
...
/************************************************************************/
/*for version*/
MK_DECL(const char *) mkit_version(void);
MK_DECL(const char *) mkit_build(void);
...
*
*/
MK_DECL(void) mkit_debug(int module, mkit_debuglog cb);
...
*
*/
MK_DECL(int) mktask_create(mkit_handle_t * handle, const char * name);
...
*
*/
MK_DECL(int) mktask_destroy(mkit_handle_t  handle);
...
*
*/
MK_DECL(int) mktask_config(mkit_handle_t  handle, int depth, int buf_max, int buf_per, int tmr_max,
                           int priority, int peekms, int flags);
...
*
*/
MK_DECL(int) mktask_run(mkit_handle_t  handle, mkit_callback event, void * private_data);
...
*
*/
MK_DECL(int) mktask_start(mkit_handle_t  handle, mkit_callback event, void * private_data);
...
*
*/
MK_DECL(int) mktask_stop(mkit_handle_t  handle, int sync);
...
*
*/
MK_DECL(int) mktask_term(mkit_handle_t  handle);
...
*
*/
MK_DECL(int) mktask_quit(mkit_handle_t  handle);
...
*
*/
MK_DECL(int) mktask_on_init(mkit_handle_t  handle);
MK_DECL(int) mktask_on_exit(mkit_handle_t  handle);
MK_DECL(int) mktask_on_idle(mkit_handle_t  handle);
...
*
*/
MK_DECL(int) mktask_on_default(mkit_handle_t  handle, mkit_message_t * message);
...
*
*/
MK_DECL(int) mktask_do_register(mkit_handle_t  handle);
...
*
*/
MK_DECL(int) mktask_do_poll(mkit_handle_t  handle, mkit_message_t * message, int timeout);
...
*
*/
MK_DECL(int)   mkservice_init(const char * master_key, int reset);
...
*
*/
MK_DECL(int)   mkservice_exit(void);
...
*
*/
MK_DECL(void *) mkservice_data(void);
...
*
*/
MK_DECL(int) mkservice_register(mkit_handle_t server, int id);
...
*
*/
MK_DECL(int) mkservice_unregister(mkit_handle_t server, int id);
...
*
*/
MK_DECL(int) mkservice_set_data(mkit_handle_t server, int id, int index, unsigned long value);
...
*
*/
MK_DECL(unsigned long) mkservice_get_data(mkit_handle_t server, int id, int index);
...
*
*/
MK_DECL(int) mkservice_req_syslog(mkit_handle_t caller, const char * task, int log_id,
                                  int log_level, int type, const char * file);
MK_DECL(int) mkservice_req_stats(mkit_handle_t caller, const char * task, int breif_only);
MK_DECL(int) mkservice_req_memcheck(mkit_handle_t caller, const char * task, int details,
                                    int do_free);
MK_DECL(int) mkservice_req_reboot(mkit_handle_t caller);
...
*
*/
MK_DECL(int) mkservice_req_watch(mkit_handle_t caller, int startup_delay);
MK_DECL(int) mkservice_del_watch(mkit_handle_t caller);
...
*
*/
static inline int mkservice_req_notify(mkit_handle_t caller, mkit_target_t notifier, int event,
                                       int count)
{
...
#ifdef WIN32
/**
* @brief  :service release all shm
*
* @param  :none
*
* @warning: Can only be called once, and can not use any function Msgkit
*
* @return :0 as success,otherwise failed.
*
*/
MK_DECL(int) mkservice_quit(void);

/**
* @brief  :release mktask_peek msg
*
* @param  :peek's msg
*
* @warning:
