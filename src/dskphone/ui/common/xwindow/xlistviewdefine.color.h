...
#define IF_XLISTVIEW_SHOW_ITEMS_BY_PAGE 1
// 滚动条是否表示位置范围(正常在滑动场景下使用)
#define IF_XLISTVIEW_SCROLL_BAR_DENOTE_POSTION 0
// 滚动条是否表示Item数量(黑白屏)
#define IF_XLISTVIEW_SCROLL_BAR_DENOTE_ITEM_COUNT 0
...
// 是否支持NOTE与Item一样显示
#define IF_XLISTVIEW_NOTE_SHOW_IN_ITEM 0
...
// 是否支持反色焦点效果
#define IF_XLISTVIEW_FOCUS_INVERT_EFFECT 0
// 是否支持在xListView中画焦点背景
#define IF_XLISTVIEW_FOCUS_ITEM_BG_PAINTER 1

// 是否支持分隔线
#define IF_XLISTVIEW_ITEM_SPACE_BY_LINE 1
