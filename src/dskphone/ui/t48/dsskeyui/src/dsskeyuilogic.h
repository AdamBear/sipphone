...
public:
    ...
    // 刷新多个连续的Dsskey数据
    void RefreshMultipleDsskeyData(int iBegin, int num, DSSKEY_MODULE_TYPE eModule);
    ...
    void UpdateDsskeyLight(int iIndex, DSS_KEY_COLOR_TYPE eColorType, DSS_KEY_FLASH_TYPE eFlashType);
