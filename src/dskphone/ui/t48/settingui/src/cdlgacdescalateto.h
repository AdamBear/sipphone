/************************************************************************
 * FileName  : CDlgACDEscalateTo.h (header file)
 * Purpose   :
 * Date      : 2012/12/23 16:10:48
 ************************************************************************/

#ifndef _CDLGACDESCALATETO_H_
#define _CDLGACDESCALATETO_H_
...
class CFrameContacts;

class CDlgACDEscalateTo : public CDlgBaseSubPage
{
    Q_OBJECT
public:
    static CBaseDialog * CreateInstance()
    {
        return new CDlgACDEscalateTo();
    }

public:
    CDlgACDEscalateTo(QWidget * parent = NULL);

    virtual ~CDlgACDEscalateTo();
