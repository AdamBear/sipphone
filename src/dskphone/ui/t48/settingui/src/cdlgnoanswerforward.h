#ifndef CDLGNOANSWERFORWARD_H
#define CDLGNOANSWERFORWARD_H
...
class CDlgNoAnswerForward
    : public CDlgBaseFwdPageUI
{
    Q_OBJECT

public:
    explicit CDlgNoAnswerForward(QWidget * parent = 0);
    virtual ~CDlgNoAnswerForward();

    static CBaseDialog * CreateInstance()
    {
        return new CDlgNoAnswerForward();
    }
