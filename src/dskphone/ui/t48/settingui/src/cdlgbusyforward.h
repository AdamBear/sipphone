#ifndef CDLGBUSYFORWARD_H
#define CDLGBUSYFORWARD_H
...
class CDlgBusyForward
    : public CDlgBaseFwdPageUI
{
    Q_OBJECT

public:
    explicit CDlgBusyForward(QWidget * parent = 0);
    virtual ~CDlgBusyForward();

    static CBaseDialog * CreateInstance()
    {
        return new CDlgBusyForward();
    }
    // 重写接受按钮消息
