#ifndef DLGNETWORKVLANCDP_H
#define DLGNETWORKVLANCDP_H
...
class CDlgNetworkVlanCDP : public CDlgBaseSubPage
{
    Q_OBJECT

public:
    explicit CDlgNetworkVlanCDP(QWidget * parent = 0);
    ~CDlgNetworkVlanCDP();

    // 取得实例
    static CBaseDialog * CreateInstance()
    {
        return new CDlgNetworkVlanCDP();
    }
