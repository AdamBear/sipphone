#ifndef CDLGANONYMOUSREJECTION_H__
#define CDLGANONYMOUSREJECTION_H__

#include "cdlgbasesubpage.h"

class qCheckBox;

class CDlgAnonymousRejection : public CDlgBaseSubPage
{
    Q_OBJECT

public:
    explicit CDlgAnonymousRejection(QWidget * parent = 0);
    ~CDlgAnonymousRejection();

    static CBaseDialog * CreateInstance()
    {
        return new CDlgAnonymousRejection();
    }
...
#endif // CDLGANONYMOUSREJECTION_H__
