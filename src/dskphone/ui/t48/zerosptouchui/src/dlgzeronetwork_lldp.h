#ifndef DLGZERONETWORKLLDP_H
#define DLGZERONETWORKLLDP_H
...
class CDlgZeroNetwork_LLDP : public CDlgBaseSubPage
{
    Q_OBJECT

public:
    explicit CDlgZeroNetwork_LLDP(QWidget * parent = 0);
    ~CDlgZeroNetwork_LLDP();

    // 取得实例
    static CBaseDialog * CreateInstance()
    {
        return new CDlgZeroNetwork_LLDP();
    }
...
public slots:
    void OnChkBoxEnableLLDPChanged(bool bOn);
