...
#ifdef IF_FEATURE_PSTN
void CDirDssKeyMgr::CreateDssKeyLocalFavorite()
{
    CDssKeyActionLocalFavorite * pAction = new CDssKeyActionLocalFavorite;
    ...
    m_mapDssKey[DT_LOCAL_FAVORITE] = pAction;
}
#endif
