#ifndef __BSFT_SEARCH_LAYOUT_H__
#define __BSFT_SEARCH_LAYOUT_H__
...
class CBSFTSearchLayout : public CDetailLayout
{
public:
    CBSFTSearchLayout();
    virtual ~CBSFTSearchLayout();
...
typedef CBSFTSearchLayout * CBSFTSearchLayoutPtr;
