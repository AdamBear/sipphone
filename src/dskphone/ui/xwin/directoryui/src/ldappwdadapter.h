#ifndef __LDAP_PWD_ADAPTER_H__
#define __LDAP_PWD_ADAPTER_H__
...
class CLDAPPwdAdapter : public CDirectoryAdapter
{
public:
    CLDAPPwdAdapter();
    virtual ~CLDAPPwdAdapter();

public:
    static CLDAPPwdAdapter * GetLDAPPwdAdapter(CDirectoryAdapterPtr & pAdapter);
...
protected:
    CEditListItem * m_pUserItem;
    CEditListItem * m_pPwdItem;
};
#endif  //IF_FEATURE_34162

#endif  //__LDAP_PWD_ADAPTER_H__
