...
///////////talkuilogic//////////
#include "talkuilogic/uilogicconnectuibase.h"
...
class CDlgConnectUI : public CDlgBaseTalkUI, public CUILogicConnectUIBase
{
public:
    explicit CDlgConnectUI();
...
protected:
    virtual void SetContactInfo(CConnectUIData * pConnectUIData);
    virtual void SetConnectAnimation();
...
private:
    ...
    xAnimationBox* m_pConnectContactAnimation;
    xAnimationBox* m_pConnectAnimation;
};
