...
#define  IPVP_MODE_NA23          23     /*NA*/
#define  IPVP_MODE_NA24          24     /*NA*/
#define  IPVP_MODE_NA25          25     /*NA*/
#define  IPVP_MODE_NA26          26     /*NA*/
#define  IPVP_MODE_NA27          27     /*NA*/
...
#define  IPVP_SLAVE_MAX         7   /*max usage*/
/*
* type of echo test
*/
...
#define  IPVP_VIDEO_PM_MSLICES   0   /*multi-slices*/
#define  IPVP_VIDEO_PM_SSLICES   1   /*single-slices*/
...
*---------------------------------------------------------------------
*/
#define IPVP_MSG_COMMON_MIN           MKSRV_MSG(MKSRV_ID_IPVP,0)
...
/*
* usage   :to receive notify dump event
*          
* id      :17
* target  :ipvp server
* wparam  :event : 0==stop dump,1==start
* lparam  :none
* data_ptr:none
* data_len:none
*/
#define IPVP_MSG_AUDIO_DUMP          MKSRV_MSG(MKSRV_ID_IPVP,64+17)
...
#define IPVP_MSG_MEDIA_MAX           MKSRV_MSG(MKSRV_ID_IPVP,255)
...
#define  IPVP_FL_GROUP_MASK         0x0F000000                            /*talk group:mask*/
...
typedef struct
{
    ...
    unsigned short          sa_len;     /*real len of 'src' or 'dst'*/
    union
    {
...
typedef struct
{
    ...
    unsigned short  reserved[7];                    /*for reserved */
}ipvp_acodec_t;
