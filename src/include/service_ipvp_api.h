...
*           control: for reserved
* @warning:
*          some salve will conflict with mode such as IPVP_MODE_BTES&IPVP_SLAVE_BTHF
* @return :0 is success,otherwise failed.
* 
*/
IPVP_API int ipvp_set_slave(mkit_handle_t caller, int slave, int dir, int control);
...
IPVP_API int ipvp_audio_tuning_term (mkit_handle_t caller);
